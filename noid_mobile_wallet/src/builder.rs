...
use crate::state::{WalletState, WalletUtxo};

/// Maximum number of wallet inputs used by one consolidation operation.
///
/// This is wallet policy and must not depend on the RPC transport layer.
