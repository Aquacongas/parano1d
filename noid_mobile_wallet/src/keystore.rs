...
impl Keystore {
    ...
    pub(super) fn create_plain(&self) -> Result<MasterSecret, KeystoreError> {
        ...
        // Android app-private storage does not reliably permit the Unix
        // temp-inode + hard_link installation strategy used on desktop.
        //
        // create_new still gives us the critical property that an existing
        // wallet can never be overwritten.
        ...
        {
            // Desktop Unix installation:
            // create a unique private inode and hard-link it atomically into
            // the final wallet path without replacing an existing wallet.
            let tmp = self
                .path
